...
def get_model(name, args):
    ...
    if name == "snn":
        ...
        return PSNN_Model(device = args.device ,input_size = args.input_size, output_size = args.output_size, pathway_mask = args.pathway_mask, pathway_nodes = args.pathway_nodes, dropout_rate = args.dropout).to(args.device)
    elif name == "cnn":
