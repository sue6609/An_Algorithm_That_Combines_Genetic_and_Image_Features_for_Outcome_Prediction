...
class GatedMultimodalUnit(nn.Module):
    ...
    def forward(self, modality1, modality2):
        ...
        # 計算 z1 和 z2
        # z1 = self.sigmoid(self.linear_z1(torch.cat((modality1, modality2), dim=1)))  # 基於兩個模態的聯合信息
        # z2 = self.sigmoid(self.linear_z2(torch.cat((modality1, modality2), dim=1)))  # 基於兩個模態的聯合信息
