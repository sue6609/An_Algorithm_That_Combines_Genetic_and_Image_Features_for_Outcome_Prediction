...
- `loss_function.py` provides the loss function for Cox survival analysis (CoxLoss), used for training and evaluating survival analysis models by computing the loss between predicted risk scores and actual survival data.
