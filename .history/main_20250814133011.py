...
from loss_functions import CoxLoss
from train_eval import train, test, evaluate_test_set
...
if __name__ == "__main__":
    args = parse_args()
    cfg = get_default_config(args)

    # Data
    train_loader = torch.utils.data.DataLoader(
        DatasetLoader(cfg.data_cv, 'train', args.mode),
